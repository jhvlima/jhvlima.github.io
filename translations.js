const translations = {
    ...
    en: {
        ...
        education_details_summary: "View all completed courses",
        education_details_content: `
            <ul>
                <li><strong>1st Semester ✅:</strong> Programming I, Calculus I, Theoretical Aspects of Computing, Introduction to Computer Science.</li>
    ...
    pt: {
        ...
        education_details_summary: "Ver todas as disciplinas cursadas",
        education_details_content: `
            <ul>
                <li><strong>1° Período ✅:</strong> Programação I, Cálculo I, Aspectos Teóricos da Computação, Introdução à Ciência da Computação.</li>
                ...
                <li><strong>9° Período ⏳:</strong> Trabalho de Conclusão de Curso I.</li>
                <li><strong>10° Período ⏳:</strong> Trabalho de Conclusão de Curso II.</li>
            </ul>`,
